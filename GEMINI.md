...
just gem-ent-register-alloydb "SOC Manager (AlloyDB)"  # Register AlloyDB agent with Gemini Enterprise
just gem-ent-register  # Register with Gemini Enterprise Agent Platform
...
python manage.py gem-ent create-app \
  --name "My Agent App" \
...
**Stage 3 (Integration Outputs)**: Generated by `just gem-ent-register`
- `GEM_ENT_AGENT_ID`, `GEM_ENT_APP_ID`
...
1. **justfile** - Traditional just-based interface
   - `just agent-engine-list`, `just gem-ent-register`, etc.
