...
provenance:
  ...
  is_fine_tune_safe: true | false
---
```
Rules for `is_fine_tune_safe`:
- Set to `true` for files generated by APIs, scripts, or written manually.
- Set to `false` for any content generated by an LLM (generative AI). Content generated by LLMs must never be used to fine-tune future models to avoid degradation.
