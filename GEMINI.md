...
- `AGENT_ENGINE_ID` (Optional: Required for Memory Bank/NotebookLM features - auto-resolved if possible)
...
- **Memory Bank not working**: Ensure `AGENT_ENGINE_ID` is available or redeploy the agent
