...
output_dir = "/Users/dandye/Projects/agentic_soc_agentspace__worktrees/elastic_v0001/harvested_investigations"
...
def harvest(
    ...
    while harvested_count < target_total:
        ...
        for inv in investigations:
            ...
            # Fetch Alert Info & Extract Detections
...
def generate_case_markdown(case):
    ...
    if create_time_ms:
        try:
            ...
            print(
                f"Warning: Failed to parse case creation time '{create_time_ms}': {e}"
            )
...
def generate_rich_case_markdown(case, alerts, output_dir):
    ...
    try:
        ...
        print(f"Warning: Failed to fetch associated investigations: {e}")
