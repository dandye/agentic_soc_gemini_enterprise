    ...
    "default": [
        {
            "surfaceUpdate": {
                "surfaceId": "main",
                "components": [{"id": "root", "component": {"Card": {"child": "msg"}}}],
            }
        },
        {
            "surfaceUpdate": {
                ...
                "components": [
                    {
                        ...
                        "component": {
                            "Text": {
                                "text": {
                                    "literalString": "I am the SOC Agent. Ask me to 'triage alert', 'hunt for threats', or 'investigate case'."
                                }
                            }
                        },
                    }
...
@app.get("/")
async def get_index():
    with open("a2ui_demo/index.html") as f:
